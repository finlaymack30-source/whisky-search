...
const C = {
  ...
  terracottaBg: '#F5EEEC',
  green: '#3A6B52',
  // Market report page retains some original palette items
  amber: '#b8882a',
  navy: '#0f0a04',
  redBg: '#fef2f2',
  redBorder: '#fecaca',
...
export default function MarketPage() {
  ...
  const [page, setPage]           = useState('cask')
    ...
    <div style={{ fontFamily: SANS, background: C.bg, minHeight: '100vh' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <button onClick={() => setPage('cask')} style={navLink(page === 'cask')}>
            Cask valuation
          </button>
          <button onClick={() => setPage('market')} style={navLink(page === 'market')}>
            Market report
          </button>
          {!isMobile && (
            <div style={{
        ...
        {page === 'cask' && (
          <section style={{ background: C.bg, minHeight: 'calc(100vh - 60px)' }}>
            <div style={{
              ...
              {/* Two-column grid — collapses to single column once results render */}
              <div style={{
                display: 'grid',
                ...
                {/* Right column — top aligns with dateline hairline via paddingTop: 0 */}
                {!caskHasResult && (
                  <div style={{
              ...
              {/* Pull quote — full width, visible before results */}
              {!caskHasResult && (
                <div style={{
                  marginTop: 64,
